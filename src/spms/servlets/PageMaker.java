...
public class PageMaker {
	...
	private int contentnum=5; //한 페이지에 몇개 보일지
	private int startPage=0; //시작 페이지 디폴트 1
	private int endPage=4; //종료 페이지 디폴트 5
	private boolean prev = true; //이전 페이지 화살표
	private boolean next = true; //다음 페이지 화살표
	...
	public void setStartPage(int currentblock) {
		...
		//한 페이지에 5개씩 보여지므로 블록의 번호 * 블록당 페이지의 개수(5) - 4를 하면 시작 페이지 번호를 정할 수 있다.
	}
